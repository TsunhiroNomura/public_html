...
<form action="" method="post">
     <input type="text" name="name" placeholder="名前" autocomplete="off"
               value="<?php if (!empty($_POST["editNumber"])) {echo $editname; } ?>"><br>
               
        <input type="text" name="str" placeholder="コメント" autocomplete="off"
               value="<?php if (!empty($_POST["editNumber"])) {echo $editcomment;} ?>"><br>
